  ...
  <div>
    <div class="sys-setting-panel">
      ...
      >
        ...
        <!--input输入-->
        <el-form-item label="注册邮箱标题" prop="registerEmailContent">
          <el-input
            clearable
            placeholder="请输入注册邮箱标题"
        ...
        <el-form-item label="初始空间大小" prop="userInitUseSpace">
          <el-input
            clearable
            placeholder="初始化空间大小"
            v-model.number.trim="formData.userInitUseSpace"
          ></el-input>
        </el-form-item>
        <el-form-item label="注册邮箱标题">
...
const rules = {
  ...
  registerEmailContent: [{ required: true, message: "请输入注册邮箱内容" }],
  userInitUseSpace: [
